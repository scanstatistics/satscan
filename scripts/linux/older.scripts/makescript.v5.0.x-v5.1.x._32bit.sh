...
make clean
make test CC=/usr/local/gcc3.3.5/bin/gcc-3.3.5 -j2
echo zlib done
echo
...
make clean
make -r ZDVER=543 BASE_SYSTEM_FLAG=-DLINUX_BASED ZDSOURCEDIR=. ZDTARGETDIR=.. CC=/usr/local/gcc3.3.5/bin/g++-3.3.5 -j2
echo zd done
echo
...
make clean SATSCAN=/prj/satscan/linux.unix.build.dir/satscan BOOSTDIR=/prj/satscan/linux.unix.build.dir/boost/boost_1_33_1 BASIS=/prj/satscan/linux.unix.build.dir/basisdev ZDVER=543 ZDDIR=/prj/satscan/linux.unix.build.dir/zd ZDANNEX=/prj/satscan/linux.unix.build.dir/zd SHELL=/bin/sh BASE_SYSTEM_FLAG=-DLINUX_BASED CC=/usr/local/gcc3.3.5/bin/g++-3.3.5

## # see http://www.trilithium.com/johan/2005/06/static-libstdc/
## rm -f libstdc++.a
## ln -s /usr/lib/libstdc++.a libstdc++.a 

 make SATSCAN=/prj/satscan/linux.unix.build.dir/satscan BOOSTDIR=/prj/satscan/linux.unix.build.dir/boost/boost_1_33_1 BASIS=/prj/satscan/linux.unix.build.dir/basisdev ZDVER=543 ZDDIR=/prj/satscan/linux.unix.build.dir/zd ZDANNEX=/prj/satscan/linux.unix.build.dir/zd SHELL=/bin/sh BASE_SYSTEM_FLAG=-DLINUX_BASED THREAD_DEFINE=-pthread CC=/usr/local/gcc3.3.5/bin/g++-3.3.5 -j2
 strip SaTScan
