...
make clean 
make test CC="/opt/net/utils/gcc3.3.1/bin/gcc-3.3.1 -m32" -j8
echo zlib done
echo
...
make clean
make -r ZDVER=546 ZDSOURCEDIR=. ZDTARGETDIR=.. CC=/opt/net/utils/gcc3.3.1/bin/g++-3.3.1 -j8
echo zd done
echo
...
make clean SATSCAN=/prj/satscan/linux.unix.build.dir/satscan BOOSTDIR=/prj/satscan/linux.unix.build.dir/boost/boost_1_33_1 BASIS=/prj/satscan/linux.unix.build.dir/basisdev ZDVER=546 ZDDIR=/prj/satscan/linux.unix.build.dir/zd ZDANNEX=/prj/satscan/linux.unix.build.dir/zd SHELL=/bin/sh CC=/opt/net/utils/gcc3.3.1/bin/g++-3.3.1

# see http://www.trilithium.com/johan/2005/06/static-libstdc/
## rm -f libstdc++.a
## ln -s /usr/lib/libstdc++.a libstdc++.a 

make SATSCAN=/prj/satscan/linux.unix.build.dir/satscan BOOSTDIR=/prj/satscan/linux.unix.build.dir/boost/boost_1_33_1 BASIS=/prj/satscan/linux.unix.build.dir/basisdev ZDVER=546 ZDDIR=/prj/satscan/linux.unix.build.dir/zd ZDANNEX=/prj/satscan/linux.unix.build.dir/zd SHELL=/bin/sh THREAD_DEFINE=-pthreads CC=/opt/net/utils/gcc3.3.1/bin/g++-3.3.1 -j8
strip SaTScan
