...
cd $2
make clean SATSCAN=$2 BOOSTDIR=$3 COMPILATION=$4 OPTIMIZATION=$5 CC="$6 $8 $9" M_CFLAGS=-fPIC
make libsatscan.jnilib SATSCAN=$2 BOOSTDIR=$3 COMPILATION=$4 OPTIMIZATION=$5 CC="$6 $8 $9 -dynamiclib" ${10} M_CFLAGS=-fPIC JNI=$jni
