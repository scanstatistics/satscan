...
cd $2
make clean SATSCAN=$2 BOOSTDIR=$3 COMPILATION=$4 OPTIMIZATION=$5 INFOPLIST_FILE="$2/installers/izpack/mac/satscan2app/commandline-info.plist" CC="$6 $8 $9"
make SaTScan_mac SATSCAN=$2 BOOSTDIR=$3 COMPILATION=$4 OPTIMIZATION=$5 INFOPLIST_FILE="$2/installers/izpack/mac/satscan2app/commandline-info.plist" CC="$6 $8 $9" ${10}
strip SaTScan_mac
mv SaTScan_mac $1
