...
----------------------------
Several SaTScan executables are created using the Java jar wrapper Launch4j (http://sourceforge.net/projects/launch4j/).
...
going to keep a copy of the utility in the SaTScan subversion project.
