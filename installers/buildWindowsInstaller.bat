...
set javajdkx64=%fileshare%\satscan\installers\install.applications\java\jdk-17.0.16+8_windows_x64
set runtimeoutputx64=%fileshare%\satscan\build.area\satscan\installers\java\jre_x64
set javajdkx86=%fileshare%\satscan\installers\install.applications\java\jdk-17.0.16+8_windows_x86
