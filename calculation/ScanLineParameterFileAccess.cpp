...
const char * ScanLineParameterFileAccess::GetParameterLabel(ParameterType eParameterType) const {
  switch (eParameterType) {
    ...
    case RESTRICT_LL_CSV                    : return "whether to restrict clusters added to line list csv";
    case LL_CSV_CUTOFF_VALUE                : return "cutoff value when restricting clusters added to line list csv";
    ...
    case CLUSTER_SIGNIFICANCE_BY_PVAL       : return "cluster significance by p-value (line 150)";
    case CLUSTER_SIGNIFICANCE_PVAL_VALUE    : return "cluster significance p-value cutoff (line 151)";
    case EMAIL_ALWAYS_SUMMARY               : return "whether to always email results summary (line 152)";
    case EMAIL_ALWAYS_RCPTS                 : return "list of users which are always emailed (line 153)";
    case EMAIL_CUTOFF_SUMMARY               : return "whether to email results summary per cluster cluster (line 154)";
    case EMAIL_CUTOFF_RCPTS                 : return "list of users which are emailed when clusters meet cutoff (line 155)";
    case EMAIL_CUTOFF_VALUE                 : return "cutoff to email results summary per cluster cluster (line 156)";
    case EMAIL_ATTACH_RESULTS               : return "email message - attach results (line 156)";
    case EMAIL_INCLUDE_RESULTS              : return "include results/directory paths (line 157)";
    case EMAIL_CUSTOM                       : return "email custom (line 158)";
    case EMAIL_CUSTOM_SUBJECT               : return "email custom subject (line 159)";
    case EMAIL_CUSTOM_BODY                  : return "email custom message body (line 160)";
    case EMAIL_SUBJECT_NO_SIGNIFICANT       : return "*Not Used* (line 161)";
    case EMAIL_BODY_NO_SIGNIFICANT          : return "*Not Used*  (line 162)";
    case MULTIPLE_LOCATIONS_FILE            : return "filename of multiple locations for groups (163)";
