...
const char * ScanLineParameterFileAccess::GetParameterLabel(ParameterType eParameterType) const {
  switch (eParameterType) {
    ...
    case EMAIL_RESULTS_SUMMARY              : return "whether to email user an analysis results summary (line 152)";
    case EMAIL_ALWAYS_RCPTS                 : return "list of users which are always emailed (line 153)";
    case EMAIL_SIGNIFICANT_RCPTS            : return "list of users which are emailed for significant events (line 154)";
    case EMAIL_SUBJECT_NO_SIGNIFICANT       : return "subject line of email - no significant clusters (line 155)";
