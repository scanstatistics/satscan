...
void FieldValue::AllocateDataValueAsType(char cType) {
  ...
  switch (cType) {
    ...
    case DATE_FLD      : gValue.pDate = new SaTScan::Date(); break;
    ...
    case STAMP_FLD     : gValue.pTimestamp = new SaTScan::Timestamp(); break;
    case TIME_FLD      : gValue.pTime = new SaTScan::Time(); break;
...
SaTScan::Date & FieldValue::AsDate_TypeEnforced() {
   if (GetType() != DATE_FLD)
...
//Treat the value as a DATE.
SaTScan::Date & FieldValue::AsDate_TypeUnenforced() {
   return *(gValue.pDate);
}
//Treat the value as an ALPHA.
...
SaTScan::Time & FieldValue::AsTime_TypeEnforced() {
  if (GetType() != TIME_FLD)
...
//Treat the value as a TIME.
SaTScan::Time & FieldValue::AsTime_TypeUnenforced() {
   return *(gValue.pTime);
}

//Treat the value as a STAMP.
SaTScan::Timestamp & FieldValue::AsTimestamp_TypeEnforced() {
...
//Treat the value as a STAMP.
SaTScan::Timestamp & FieldValue::AsTimestamp_TypeUnenforced()  {
   return *(gValue.pTimestamp);
}
...
short FieldDef::GetDataLength() const {
  switch (gcType) {
    ...
    case FieldValue::DATE_FLD    : return SaTScan::Timestamp::DATE_FLD_LEN;
    case FieldValue::TIME_FLD    : return SaTScan::Timestamp::TIME_FLD_LEN;
    case FieldValue::STAMP_FLD   : return SaTScan::Timestamp::STAMP_FLD_LEN;
