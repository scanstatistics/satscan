...
class FieldValue {
  ...
  protected://typedefs
   ...
   typedef SaTScan::Date & (FieldValue::* DateGetter_t) ();
   typedef SaTScan::Time & (FieldValue::* TimeGetter_t) ();
   typedef SaTScan::Timestamp & (FieldValue::* TimestampGetter_t) ();
  ...
  protected:
   ...
   virtual SaTScan::Date & AsDate_TypeEnforced();
   virtual SaTScan::Date & AsDate_TypeUnenforced();
   virtual SaTScan::Time & AsTime_TypeEnforced();
   virtual SaTScan::Time & AsTime_TypeUnenforced();
   virtual SaTScan::Timestamp & AsTimestamp_TypeEnforced();
   virtual SaTScan::Timestamp & AsTimestamp_TypeUnenforced();
  ...
  public:
   ...
   inline virtual       SaTScan::Date & AsDate()                               { return (this->*gDateGetter)(); }
   inline virtual const SaTScan::Date & AsDate() const                         { return (const_cast<FieldValue *>(this)->*gDateGetter)(); }
   inline virtual       SaTScan::Time & AsTime()                               { return (this->*gTimeGetter)(); }
   inline virtual const SaTScan::Time & AsTime() const                         { return (const_cast<FieldValue *>(this)->*gTimeGetter)(); }
   inline virtual       SaTScan::Timestamp & AsTimestamp()                     { return (this->*gTimestampGetter)(); }
   inline virtual const SaTScan::Timestamp & AsTimestamp() const               { return (const_cast<FieldValue *>(this)->*gTimestampGetter)(); }
...
class FieldDef {
  ...
  public:
   ...
   static inline char TypeOf ( const SaTScan::Date & )      { return FieldValue::DATE_FLD; }
