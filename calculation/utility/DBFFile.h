...
//   inline void              AddIndex(unsigned short wField, short wNumFields, bool bPrimary, char * sViolTblName, short wIndexVersion, ZdProgressInterface *pProgress);
   ...
   virtual void             AddIndex(unsigned short wField, bool bMaintenanceBuild = false, short wNumFields = 1, bool bPrimary = true, char * sViolTblName = 0, short wIndexVersion = ZDINDEX_VERSION, ZdProgressInterface &Progress = ZdNullProgress::GetDefaultInstance() ) { ZdException::Generate("not implemented: AddIndex", "DBFFile"); }
