...
std::string                   & JulianToString(std::string& sDate, Julian JNum, DatePrecisionType eDatePrint, const char * sep = "/", bool isEndDate = false, bool asSeasonal = false, bool zeroPad = false);
