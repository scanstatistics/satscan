...
class CPurelySpatialAnalysis : public CAnalysis {
    private:
        std::shared_ptr<CPurelySpatialCluster> _cluster_compare; /** cluster object utilized to find top cluster */
        std::shared_ptr<AbstractSpatialClusterData> _cluster_data; /** cluster data object utilized in calculated simulation ratio */
