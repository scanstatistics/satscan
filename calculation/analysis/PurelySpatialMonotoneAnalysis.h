...
class CPSMonotoneAnalysis : public CAnalysis {
  private:
    std::shared_ptr<CPSMonotoneCluster> _compare_cluster;    /** cluster object utilized to find top cluster in real data */
    std::shared_ptr<CPSMonotoneCluster> _aux_compare_cluster; /** cluster object utilized to find top cluster in real data */
