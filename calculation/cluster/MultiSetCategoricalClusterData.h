...
class MultiSetCategoricalSpatialData : public AbstractSpatialClusterData {
  ...
  public:
    MultiSetCategoricalSpatialData(const CategoricalClusterDataFactory& DataFactory, const AbtractDataStreamGateway& DataGateway, int iRate);
...
class MultiSetCategoricalTemporalData : public AbstractMultiSetCategoricalTemporalData {
  public:
    MultiSetCategoricalTemporalData(const CategoricalClusterDataFactory& DataFactory, const AbtractDataStreamGateway & DataGateway);
...
class MultiSetCategoricalProspectiveSpatialData : public AbstractMultiSetCategoricalTemporalData {
  public:
    MultiSetCategoricalProspectiveSpatialData(const CategoricalClusterDataFactory& DataFactory, const CSaTScanData& Data, const AbtractDataStreamGateway& DataGateway);
...
class MultiSetCategoricalSpaceTimeData : public AbstractMultiSetCategoricalTemporalData {
  public:
    MultiSetCategoricalSpaceTimeData(const CategoricalClusterDataFactory& DataFactory, const AbtractDataStreamGateway& DataGateway);
