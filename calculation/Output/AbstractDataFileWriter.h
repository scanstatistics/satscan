...
class RecordBuffer {
   ...
   public:
      ...
      void                              DefaultBlankFieldsOfType(FieldValue default_value, const std::vector<std::string>& file_names);
      ...
      const std::vector<FieldValue>   & GetFieldValues() const { return gvFieldValues; }
