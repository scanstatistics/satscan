...
/** constructor */
NormalLikelihoodCalculator::NormalLikelihoodCalculator(count_t tTotalCases, measure_t tTotalMeasure)
...
double NormalLikelihoodCalculator::CalcLogLikelihood(count_t n, measure_t u) {
...
double NormalLikelihoodCalculator::CalcLogLikelihoodRatio(count_t n, measure_t u, count_t N, measure_t U) {
...
double NormalLikelihoodCalculator::CalcLogLikelihoodRatioEx(count_t tCases, measure_t tMeasure, measure_t tMeasure2, count_t tTotalCases, measure_t tTotalMeasure) {
