...
//	JEditorPane editPane = new JEditorPane("text/plain", btnCaseBrowse.getText());
//	documentRenderer.print(editPane);
...
/*  JDocumentRenderer prints objects of type Document. Text attributes, including
    ...
    JDocumentRenderer class can also be used as the argument in the setPrintable
    ...
    JDocumentRenderer and setting the document to be printed with the
