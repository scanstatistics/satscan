...
import org.satscan.gui.AboutDialog;
...
public class MacOSApplication extends Application {
    ...
    class MacOSApplicationAdapter implements ApplicationListener {
        ...
        public void handleAbout(ApplicationEvent arg0) {
            try {
                AboutDialog aboutDialog = new AboutDialog(SaTScanApplication.getInstance());
        ...
        public void handleQuit(ApplicationEvent arg0) {
            SaTScanApplication.getInstance().windowClosing(new WindowEvent(SaTScanApplication.getInstance(), WindowEvent.WINDOW_CLOSING));
            arg0.setHandled(true);
        }
    }
}
